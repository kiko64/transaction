                  ...
                  child: Card(
                    ...
                    child: Column(
                        children: [
                          ...
                          Text('Código usuario: ' + snapshot.data![index].documento.toString(),
                            style: TextStyle(
                              fontSize: 18,
                            ...
                            child: Column(
                              children: <Widget>[
                                Align(
                                  ...
                                  child: Text('    ' + snapshot.data![index].direccion, style: Theme.of(context).textTheme.overline ), ),
                                Align(
                                  alignment: Alignment.bottomLeft,
                                  child: Text('    ' + snapshot.data![index].adicional, style: Theme.of(context).textTheme.overline ), ),
                                Align(
                                  alignment: Alignment.bottomLeft,
                                  child: Text('    ' + snapshot.data![index].municipio, style: Theme.of(context).textTheme.overline ), ), // caption

                                SizedBox(height: 10.0),

                                Align(
                                  alignment: Alignment.bottomLeft,
                                  child: Text('  Número medidor: ' + snapshot.data![index].medidor, style: Theme.of(context).textTheme.headline6 ), ),
                                Align(
                                  alignment: Alignment.bottomLeft,
                                  child: Text('  Lectura anterior: ' + snapshot.data![index].anterior.toString().replaceAll(".", ","), style: Theme.of(context).textTheme.headline6 ), ),
                              ],
                            ),
                          ),
                          ...
                          Container(
                            ...
                            child: TextFormField(
                              ...
                              onFieldSubmitted: (term) {
                                FocusScope.of(context).requestFocus(_descripcionNovedadFocus);
                              },
                            ),
                          ),
                            ...
                            child: TextFormField(
                              ...
                              onTap: () async {
                                var data = DataEnLectura(
                                    titulo: 'Novedad',
                                    novedad: _novedad,
                                    desAgenda: _descripcionNovedad.text.toString()
                                );
                                ...
                                setState(() {
                                  ...
                                  _descripcionNovedad.text = result.desAgenda.toString();
                                  print('widget.data.actual <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<: ${result.desAgenda.toString()}');
                                  print('widget.data.actual <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<: ${result.novedad}');
                                  print('widget.data.actual <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<: ${_novedad}');
                                });
